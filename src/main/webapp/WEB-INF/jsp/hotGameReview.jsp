		...
		<div style="width:60%; float:left; margin-left:17%">
		  ...
		  <div class="w3-row-padding">
		    <div class="w3-third w3-container w3-margin-bottom">
		      ...
		      <div class="w3-container w3-white">
		        ...
		        <div>
					<p><a href="reviewDetail_hot.do">자세히보기</a></p>
		        </div>
		      </div>
		    </div>
		    <div class="w3-third w3-container w3-margin-bottom">
		  ...
		  <div class="w3-row-padding">
			...
			<div style="margin: auto; padding:10px;">
				<button class="btn btn-default" style="float:right;" onclick="location.href='hotWrite.do'">리뷰쓰기</button>	
			</div>
		  ...
		  <div class="w3-card-2 w3-margin">
		    ...
		    <ul class="w3-ul w3-hoverable w3-white">
		      <li class="w3-padding-16">
		        ...
		        <span class="w3-large" onclick="location.href='reviewDetail_hot.do'">놀러와마이홈</span><br>     
		      </li>
		      <li class="w3-padding-16">
		        <img src="http://placehold.it/50x50" />
